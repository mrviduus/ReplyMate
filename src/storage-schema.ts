 ...
 * All keys are versioned (`replymate.<area>.<vN>`); breaking changes bump SCHEMA_VERSION
...
export const STORAGE_KEYS = {
  profile: 'replymate.profile.v1',
  queueEngaged: 'replymate.queue.engaged.v1',
  queueDismissed: 'replymate.queue.dismissed.v1',
  queuePreferences: 'replymate.queue.preferences.v1',
  ssiHistory: 'replymate.ssi.history.v1',
